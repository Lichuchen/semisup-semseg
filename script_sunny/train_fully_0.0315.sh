...
--dataset CMR  \
--checkpoint-dir ../checkpoints/sunny_fully_0_03125 \
--labeled-ratio 0.0315 \
--ignore-label 255 \
--num-classes 2 \
...
--save-pred-every 500 \
--num-steps 10000 \
--split-id /mnt/lustre/lichuchen/lily/few-shot/semisup-semseg/checkpoints/sunny_semi_0_03125/train_voc_split.pkl \
2>&1 | tee ../log/sunny/train_fully_0.03125.log
