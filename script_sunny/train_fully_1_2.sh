...
--dataset CMR  \
--checkpoint-dir ../checkpoints/sunny_fully_1_2 \
--labeled-ratio 0.5 \
--ignore-label 255 \
--num-classes 2 \
...
--split-id /mnt/lustre/lichuchen/lily/few-shot/semisup-semseg/checkpoints/sunny_semi_0_5/train_voc_split.pkl \
--input-size '128,128' \
--batch-size 4 \
--save-pred-every 500 \
--num-steps 10000 \
2>&1 | tee ../log/sunny/train_fully.log
