...
--dataset CMR  \
--checkpoint-dir ../checkpoints/RV2/RV_fully_0_125 \
--ignore-label 255 \
--labeled-ratio 0.125 \
--num-classes 2 \
...
--save-pred-every 500 \
--num-steps 10000 \
--split-id /mnt/lustre/lichuchen/lily/few-shot/semisup-semseg/checkpoints/RV/RV_semi_0_125/train_voc_split.pkl \
2>&1 | tee ../log/RV/traino_fully_1_8.log
