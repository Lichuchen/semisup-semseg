...
--dataset CMR  \
--checkpoint-dir ../checkpoints/RV2/RV_fully_0_5 \
--ignore-label 255 \
--num-classes 2 \
--labeled-ratio 0.5 \
...
--save-pred-every 500 \
--num-steps 10000 \
--split-id /mnt/lustre/lichuchen/lily/few-shot/semisup-semseg/checkpoints/RV/RV_semi_0_5/train_voc_split.pkl \
2>&1 | tee ../log/RV/traino_fully_0.5.log
