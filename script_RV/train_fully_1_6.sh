...
--dataset CMR  \
--checkpoint-dir ../checkpoints/RV2/RV_fully_1_6 \
--ignore-label 255 \
--num-classes 2 \
...
--save-pred-every 500 \
--num-steps 10000 \
--split-id /mnt/lustre/lichuchen/lily/few-shot/semisup-semseg/checkpoints/RV2/RV_semi_1_6/train_voc_split.pkl \
2>&1 | tee ../log/RV/train0_fully_1_6.log
