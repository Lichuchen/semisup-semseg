...
--dataset CMR  \
--checkpoint-dir ../checkpoints/RV2/RV_fully_1_12 \
--ignore-label 255 \
--num-classes 2 \
--labeled-ratio 0.0833 \
...
--save-pred-every 500 \
--num-steps 10000 \
--split-id /mnt/lustre/lichuchen/lily/few-shot/semisup-semseg/checkpoints/RV2/RV_semi_1_12/train_voc_split.pkl \
# 2>&1 | tee ../log/RV2/traini_fully_1_12.log
