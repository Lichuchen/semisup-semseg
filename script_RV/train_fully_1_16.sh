...
--dataset CMR  \
--checkpoint-dir ../checkpoints/RV2/RV_fully_0_0625 \
--ignore-label 255 \
...
--save-pred-every 500 \
--num-steps 10000 \
--split-id /mnt/lustre/lichuchen/lily/few-shot/semisup-semseg/checkpoints/RV/RV_semi_0_0625/train_voc_split.pkl \
2>&1 | tee ../log/RV/traino_fully_0.0625.log
